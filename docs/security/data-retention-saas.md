...
2. **Export** — periodically export cold partitions to object storage for compliance archives (see `docs/architecture/audit-trail.md` for NDJSON digest tooling patterns).
