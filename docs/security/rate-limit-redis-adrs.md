...
Set **`RATE_LIMIT_REDIS_URL`** (`rediss://` for TLS, e.g. Upstash). Enable when you run **>1** App Platform instance or see abuse skew across replicas. Budgets: **`docs/security/http-rate-limit-budgets.md`**.
