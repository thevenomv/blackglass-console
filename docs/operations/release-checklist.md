...
11. **Email / exports:** If you changed report PDF or invite copy this release, spot-check one export and one transactional email in **light** branding (see `docs/operations/exports-and-comms.md`).
