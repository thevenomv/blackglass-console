...
- See `docs/saas/saas-clerk-rbac.md` and `docs/saas/clerk-ops-checklist.md`.
...
- Live cutover and soak procedures: `docs/saas/stripe-live-cutover.md`,
  `docs/saas/stripe-live-soak.md`.
...
- **SOC 2 attestation.** The control surface is in place and documented
  in `docs/security/security-compliance.md`; formal audit is in planning. Don't
...
- `docs/architecture/architecture-overview.md` — system map and invariants.
- `docs/security/security-compliance.md` — control mapping for security reviewers.
- `docs/runbooks/operations.md` — DR + queues + DLQ + showcase status.
- `docs/saas/saas-clerk-rbac.md` — RBAC + Clerk integration matrix.
