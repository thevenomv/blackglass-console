...
- **Internal:** primary data protection contact `jamie@obsidiandynamics.co.uk` (see `/.well-known/security.txt`; override with `NEXT_PUBLIC_SECURITY_CONTACT_EMAIL` when a dedicated inbox exists).
