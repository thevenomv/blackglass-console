    ...
    <div className="space-y-10">
      <header className="space-y-2">
        ...
        <p className="text-xs text-fg-faint">
          Full RustDesk + firewall reference:{" "}
          <Link
            href="https://github.com/thevenomv/blackglass-console/blob/main/docs/rustdesk-demo-setup.md"
            className="text-accent-blue hover:underline"
            target="_blank"
            rel="noreferrer"
          >
            docs/rustdesk-demo-setup.md
          </Link>
        </p>
      </header>
      ...
      <section className="space-y-4">
        ...
        <p className="text-sm text-fg-muted">
          ...
          the ID host and cloud firewall (see docs).
        </p>
