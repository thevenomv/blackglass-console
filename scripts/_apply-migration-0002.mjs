...
const sql = readFileSync("./drizzle/0002_add_evidence_bundles.sql", "utf8");
const statements = sql
  .split("--> statement-breakpoint")
  .map((s) => s.trim())
  .filter(Boolean);

// Strip sslmode param â€” DO managed Postgres uses self-signed CA;
...
await client.end();
console.log("Migration 0002_add_evidence_bundles complete.");
